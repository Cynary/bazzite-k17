...
RUN dnf install -y gcc make binutils elfutils-libelf-devel openssl-devel dwarves python3 kmod cpio zstd xz bc bison flex diffutils findutils curl tar gzip && dnf clean all
